...
contract NodeController is INodeProxy{
    ...
    function setNodeIngress(address nodeIngressAddress) external onlyCreator {
        nodeIngress = NodeIngress(nodeIngressAddress);
    }
    ...
    function setIdOnlyMode(bool value) external onlyAdmin{
